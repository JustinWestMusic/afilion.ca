...
<html class="no-js" lang="en" dir="ltr">
  <head>
    ...
    <meta name="description" content="Afilion - Contact Thank You">
    <title>Afilion | Thank You</title>
  ...
  <body>
      ...
      <div class="large-12 columns">
        <h1 class="hide">Afilion | Thank You</h1>
      </div>
    </div>
  ...
  <header class="expanded row align-justify">
    ...
    <section class="row">
    <div class="small-12 column" id="tySec">
	<h2>Thank you for sending me a message.</h2>
	<h4>I will get back to you as quickly as I can!</h4>
	<a href="contact.php" id="goBack">Go back</a>
	</div>
  </section>
